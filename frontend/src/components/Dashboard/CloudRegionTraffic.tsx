...
import { CloudRegion, RegionStats } from '@/types';
import styles from './CloudRegionTraffic.module.scss';
...
const CloudRegionTraffic: React.FC<Props> = ({ topRegions, regionStats }) => {
  ...
  return (
    <section className={styles.section}>
      <div className={styles.header}>
        <h2>四、云区域流量态势</h2>
        <span className={styles.subtitle}>Cloud Region Traffic Situational Awareness</span>
      </div>
        ...
        <div className={styles.rightPanel}>
          <div className={styles.panelHeader}>
            <div className={styles.titleGroup}>
              <h4>区域流量 TOP 5</h4>
              <span className={styles.panelSubtitle}>Regional Traffic Distribution</span>
...
export default CloudRegionTraffic;
